...
class BJSportsTestCase(unittest.TestCase):
    ...
    def test_registration_requires_versioned_terms_and_image_authorization(self):
        ...
        self.assertIn('Saúde e prática esportiva', page)
        ...
        self.assertIn('Prefiro não responder', page)
    ...
    def test_monitor_controls_scoreboard_while_student_has_read_only_access(self):
        ...
        self.assertIn('1 bipe ao iniciar · 2 aos 30s · 1 ao finalizar', free_timer)
        ...
        self.assertIn('Confronto criado e pronto para o placar.', monitor_page)
